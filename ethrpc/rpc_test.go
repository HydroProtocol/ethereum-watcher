...
func (s *RPCTestSuite) SetupSuite() {
	s.rpc = NewRPC("http://127.0.0.1:8545", WithHttpClient(http.DefaultClient), WithLogger(nil), WithDebug(false))
...
func (s *RPCTestSuite) TestWeb3ClientVersion() {
...
func (s *RPCTestSuite) TestWeb3Sha3() {
...
func (s *RPCTestSuite) TestNetVersion() {
...
func (s *RPCTestSuite) TestNetListening() {
...
func (s *RPCTestSuite) TestNetPeerCount() {
	// Test error
...
func (s *RPCTestSuite) TestEthProtocolVersion() {
...
func (s *RPCTestSuite) TestEthSyncing() {
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthCoinbase() {
...
func (s *RPCTestSuite) TestEthMining() {
...
func (s *RPCTestSuite) TestEthHashrate() {
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGasPrice() {
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthAccounts() {
	s.registerResponse(`["0x407d73d8a49eeb85d32cf465507dd71d507100c1"]`, func(body []byte) {
...
func (s *RPCTestSuite) TestEthBlockNumber() {
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGetBalance() {
...
func (s *RPCTestSuite) TestEthGetStorageAt() {
...
func (s *RPCTestSuite) TestEthGetTransactionCount() {
	address := "0x407d73d8a49eeb85d32cf465507dd71d507100c1"
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGetBlockTransactionCountByHash() {
...
func (s *RPCTestSuite) TestEthGetBlockTransactionCountByNumber() {
	number := 2384732
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGetUncleCountByBlockHash() {
	hash := "0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238"
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGetUncleCountByBlockNumber() {
	number := 3987434
	s.registerResponseError(errors.New("Error"))
...
func (s *RPCTestSuite) TestEthGetCode() {
...
func (s *RPCTestSuite) TestEthSign() {
...
func (s *RPCTestSuite) TestSendTransaction() {
	t := T{
...
func (s *RPCTestSuite) TestEthSendRawTransaction() {
...
func (s *RPCTestSuite) TestEthGetCompilers() {
...
func (s *RPCTestSuite) TestEthGetBlockByHash() {
	// Test with transactions
	hash := "0x111"
...
func (s *RPCTestSuite) TestEthGetBlockByNumber() {
	// Test with transactions
	number := 3274863
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *RPCTestSuite) TestEthCall() {
...
func (s *RPCTestSuite) TestEthEstimateGas() {
	s.registerResponseError(errors.New("error"))
...
func (s *RPCTestSuite) TestEthGetTransactionReceipt() {
...
func (s *RPCTestSuite) TestGetTransaction() {
	result := `{
...
func (s *RPCTestSuite) TestEthGetTransactionByHash() {
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *RPCTestSuite) TestEthGetTransactionByBlockHashAndIndex() {
	s.registerResponse(`{}`, func(body []byte) {
...
func (s *RPCTestSuite) TestEthNewFilterWithAddress() {
...
func (s *RPCTestSuite) TestEthNewFilterWithTopics() {
	topics := [][]string{
		{
...
func (s *RPCTestSuite) TestEthNewFilterWithAddressAndTopics() {
	topics := [][]string{
		{"0xb2b2eeeee341e560da3d439ef5e5309d78a22a66"},
		{"0xb2b2fffff341e560da3d439ef5e5309d78a22a66"},
	}
...
func (s *RPCTestSuite) TestEthNewBlockFilter() {
	result := "0x6996a3a4788d4f2067108d1f536d4330"
	s.registerResponse(fmt.Sprintf(`"%s"`, result), func(body []byte) {
...
func (s *RPCTestSuite) TestEthNewPendingTransactionFilter() {
	result := "0x153"
	s.registerResponse(fmt.Sprintf(`"%s"`, result), func(body []byte) {
...
func (s *RPCTestSuite) TestEthGetFilterChanges() {
...
func (s *RPCTestSuite) TestEthGetFilterLogs() {
	filterID := "0x6996a3a4788d4f2067108d1f536d4330"
	result := `[{
		"address": "0xaca0cc3a6bf9552f2866ccc67801d4e6aa6a70f2",
		"blockHash": "0x9d9838090bb7f6194f62acea788688435b79cc44c62dcf1479abd9f2c72a7d5c",
...
func (s *RPCTestSuite) TestEthGetLogs() {
	params := FilterParams{
		FromBlock: "0x1",
		ToBlock:   "0x10",
...
func (s *RPCTestSuite) TestEthUninstallFilter() {
	filterID := "0x6996a3a4788d4f2067108d1f536d4330"
	result := "true"
	s.registerResponse(result, func(body []byte) {
